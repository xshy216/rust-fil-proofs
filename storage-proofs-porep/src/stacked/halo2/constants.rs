pub use storage_proofs_core::drgraph::BASE_DEGREE as NUM_DRG_PARENTS;

pub use crate::stacked::{
    vanilla::TOTAL_PARENTS as REPEATED_PARENTS_LEN, EXP_DEGREE as NUM_EXP_PARENTS,
};
...
// The number of `u32` words all DRG and expander parent labels are decomposed into.
pub const DRG_PARENT_LABELS_WORD_LEN: usize = NUM_DRG_PARENTS * LABEL_WORD_LEN;
pub const EXP_PARENT_LABELS_WORD_LEN: usize = NUM_EXP_PARENTS * LABEL_WORD_LEN;

// The number of `u32` words produced by repeating parent labels.
pub const REPEATED_PARENT_LABELS_WORD_LEN: usize = REPEATED_PARENTS_LEN * LABEL_WORD_LEN;
